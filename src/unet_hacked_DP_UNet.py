...
from src.unet_block_hacked_DP_UNet import (
    UNetMidBlock2D,
    ...
    def forward(
        ...
        for downsample_block in self.down_blocks:
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                ...
                sample, res_samples,out_texture_feat = downsample_block(
                ...
                texture_features += out_texture_feat
            else:
        ...
        if self.mid_block is not None:
            if hasattr(self.mid_block, "has_cross_attention") and self.mid_block.has_cross_attention:
                sample,out_texture_feat = self.mid_block(
                    sample,
                    emb,
                    encoder_hidden_states=encoder_hidden_states,
                    attention_mask=attention_mask,
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            if hasattr(upsample_block, "has_cross_attention") and upsample_block.has_cross_attention:
                sample,out_texture_feat = upsample_block(
                    hidden_states=sample,
                    temb=emb,
        ...
        if not return_dict:
            return (sample,),texture_features

        return UNet2DConditionOutput(sample=sample),texture_features
