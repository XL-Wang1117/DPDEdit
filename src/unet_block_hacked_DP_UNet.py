...
from src.transformerhacked_DP_UNet import Transformer2DModel
    ...
    def forward(
        ...
        for attn, resnet in zip(self.attentions, self.resnets[1:]):
            if self.training and self.gradient_checkpointing:
                ...
                # hidden_states = attn(
                hidden_states,out_texture_feat = attn(
                    hidden_states,
        ...
        return hidden_states,texture_features
        # return hidden_states 
...
class CrossAttnDownBlock2D(nn.Module):
    ...
    def forward(
        ...
        return hidden_states, output_states,texture_features
