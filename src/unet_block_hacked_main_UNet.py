...
from src.transformerhacked_main_UNet import Transformer2DModel
    ...
    def forward(
        ...
        for attn, resnet in zip(self.attentions, self.resnets[1:]):
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states,curr_texture_feat_idx = attn(
                    hidden_states,
        ...
        return hidden_states,curr_texture_feat_idx
...
class CrossAttnDownBlock2D(nn.Module):
    ...
    def forward(
        ...
        return hidden_states, output_states,curr_texture_feat_idx
